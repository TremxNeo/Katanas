...
public class NetheriteLight extends JavaPlugin {
    ...
    private static void createLightNetheriteKatana() {
        ...
        assert im != null;
        im.setDisplayName(ChatColor.LIGHT_PURPLE + Katanas.getCurrentLang().getString("light-katanas.netherite"));
        ...
        ShapedRecipe sr = new ShapedRecipe(NamespacedKey.minecraft("netherite_katana_light"), item);
        sr.shape("  X", " X ", "Z  ");
